...
// Rows are generated by the shift-register chain; MCU switch column inputs are direct.
constexpr uint8_t CAPTAIN_MATRIX_ROW_PINS[CAPTAIN_SWITCH_ROWS] = {0, 1, 2, 3, 4, 5, 6, 7};
// Empirical switch bring-up mapping (2026-05-06):
// logical cols 0..3 map to MCU inputs GPIO20, GPIO18, GPIO21, GPIO19.
// This corrects the observed permutation where physical switch columns landed on
// the wrong logical columns during live matrix tests.
constexpr uint8_t CAPTAIN_MATRIX_SWITCH_COL_PINS[CAPTAIN_SWITCH_COLS] = {20, 18, 21, 19};
